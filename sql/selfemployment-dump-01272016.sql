...
INSERT INTO `clienttbl` (`id`, `name`, `status`, `rate`, `address1`, `address2`, `city`, `state`, `zip`) VALUES (1,'Museum of Science',1,60.00,'1 Science Park','','Boston','MA','02114');
INSERT INTO `clienttbl` (`id`, `name`, `status`, `rate`, `address1`, `address2`, `city`, `state`, `zip`) VALUES (2,'Health Allianze',1,20.00,'5 Masconomo St','','Manchester','MA','01944');
INSERT INTO `clienttbl` (`id`, `name`, `status`, `rate`, `address1`, `address2`, `city`, `state`, `zip`) VALUES (7,'test i',1,78.00,'test a 1 ','test a 2','testc','AZ','01867');
INSERT INTO `clienttbl` (`id`, `name`, `status`, `rate`, `address1`, `address2`, `city`, `state`, `zip`) VALUES (8,'test 2',1,76.00,'test','test','test','AL','01944');
...
INSERT INTO `projectdailytimetbl` (`id`, `projectid`, `enterdate`, `starttime`, `stoptime`, `timeinterval`, `intervaldescription`, `invoiceid`) VALUES (7,2,'2016-01-20 00:00:00','2016-01-20 09:34:00','2016-01-20 10:00:00',0.4,'test 3 and fun',NULL);
...
INSERT INTO `projectdailytimetbl` (`id`, `projectid`, `enterdate`, `starttime`, `stoptime`, `timeinterval`, `intervaldescription`, `invoiceid`) VALUES (27,6,'2016-01-26 00:00:00','2016-01-26 14:15:00','2016-01-26 16:30:00',2.25,'Development and Examples',NULL);
INSERT INTO `projectdailytimetbl` (`id`, `projectid`, `enterdate`, `starttime`, `stoptime`, `timeinterval`, `intervaldescription`, `invoiceid`) VALUES (28,2,'2016-01-20 00:00:00','2016-01-20 10:35:00','2016-01-20 23:24:00',12.82,'Development',NULL);
...
-- Dump completed on 2016-01-27 18:30:12
